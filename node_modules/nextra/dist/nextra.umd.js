(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('path'), require('graceful-fs'), require('child_process'), require('util'), require('download'), require('remark'), require('strip-markdown')) :
  typeof define === 'function' && define.amd ? define(['path', 'graceful-fs', 'child_process', 'util', 'download', 'remark', 'strip-markdown'], factory) :
  (global = global || self, global.nextra = factory(global.path, global.gracefulFs, global.childProcess, global.util, global.download, global.remark, global.stripMarkdown));
}(this, (function (path, gracefulFs, cp, util, download, remark, strip) {
