...
draft: false
summary: Talking about my goals for this site, as well as how initially planning to build it.
images: []
layout: PostLayout
...
I already decided to use [Next.js](https://nextjs.org/) with [Tailwind](https://tailwindcss.com/) as the framework for this website, mostly becauses that's what we use for projects I'm on for work and would like to be able to better understand how I can help our developers.
